...
DB_NAME="vectiscan"
DB_USER="vectiscan"
DB_PASSWORD="vectiscan-dev-2026"
MINIO_ACCESS_KEY="vectiscan-minio"
MINIO_SECRET_KEY="vectiscan-minio-dev-2026"

info "Testumgebung — DB/MinIO-Credentials sind vorbelegt."
ok "  DB:    ${DB_USER} / ${DB_NAME}"
ok "  MinIO: ${MINIO_ACCESS_KEY}"
