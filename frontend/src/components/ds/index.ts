// VectiScan Design-System Primitive (VEC-306)
// Kanonische, wiederverwendbare UI-Bausteine. Von VEC-293 (Onboarding)
// und VEC-294 (Permission-/Abo-Gating) mitbenutzt — eine Sprache.
