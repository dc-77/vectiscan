...
export default function RootLayout({
  ...
  return (
    <html lang="de" className="dark">
      {/* AppShell wählt intern zwischen Sidebar-Shell (App-Seiten) und
          dem öffentlichen Top-Header (Marketing/Auth). */}
      <body className={`${inter.className} min-h-screen bg-[#0C1222] text-gray-200 antialiased flex flex-col`}>
        ...
        {/* Global scanline overlay — nur visueller Effekt, kein semantischer Inhalt */}
